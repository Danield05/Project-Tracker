...
<form class="border border-white p-3" action="{{url('budget/'.$data->id)}}" method="POST">
  @csrf
  @method('PUT')
  <div class="mb-3 row">
  ...
  <div class="mb-3 row">
    <label for="inputBudget" class="col-sm-2 col-form-label">Monthly Budget($)</label>
    <div class="col-sm-8">
      <input type="number" class="form-control" id="budget" name="budget" step="0.01"  value="{{ $data->budget }}" required  min="0.01" >
    </div>
    
  </div>
  <div class="mb-3 row">
    <div class="col-sm-10 offset-sm-2">
      <a href="/budget" class="btn btn-danger">Cancel</a>
